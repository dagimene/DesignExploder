...
public class StylesFactory {
	...
	private StylesFactory(){
        ...
        styles.put(INJECTION_PROXIES_COLLECTION, Style.INJECTION_PROXIES_COLLECTION);
        ...
        styles.put(IOC_METHOD_FACTORY_UNRESOLVED, Style.IOC_METHOD_FACTORY_UNRESOLVED);
		styles.put(IOC_METHOD_INIT, Style.IOC_METHOD_INIT);
        styles.put(IOC_METHOD_FINALIZE, Style.IOC_METHOD_FINALIZE);
		styles.put(IOC_METHOD_INSTANTIATE, Style.IOC_METHOD_INSTANTIATE);
        styles.put(IOC_METHOD_INSTANTIATE_UNRESOLVED, Style.IOC_METHOD_INSTANTIATE_UNRESOLVED);
