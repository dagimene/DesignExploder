...
class ClassRelationImpl extends NaturalizedImpl implements ClassRelation {

	private int originCardinality;
	private int targetCardinality;
	private Attribute origin;
	
	public ClassRelationImpl() {
	...
	private ModelEventListener targetListener = new ModelEventListener() {
		...
		public void processModelEvent(ModelEvent e) {
			...
			fowardEvent.setSource(ClassRelationImpl.this);
	...
	@Override
	@SuppressWarnings("unchecked")
	public Class<ClassRelation> getExtensionClass() {
		return ClassRelation.class;
	}
